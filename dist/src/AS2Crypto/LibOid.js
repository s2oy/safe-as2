...
exports.ObjectID = exports.objectIds = exports.LibObjectID = void 0;
...
exports.LibObjectID = LibObjectID;
exports.objectIds = LibObjectID.init();
class ObjectID {
    constructor({ name, id }) {
        if (Helpers_1.isNullOrUndefined(name) && Helpers_1.isNullOrUndefined(id)) {
            throw new Error('Cannot find ObjectID by undefined or null values.');
        }
        if (!Helpers_1.isNullOrUndefined(name)) {
            return exports.objectIds.byName(name);
        }
        else {
            return exports.objectIds.byId(id);
        }
    }
}
